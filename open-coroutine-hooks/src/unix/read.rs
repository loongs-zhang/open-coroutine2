...
pub extern "C" fn recv(socket: c_int, buf: *mut c_void, len: size_t, flags: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::recv(Some(Lazy::force(&RECV)), socket, buf, len, flags)
}
...
pub extern "C" fn recvfrom(
    ...
    open_coroutine_core::syscall::facade::recvfrom(
...
pub extern "C" fn pread(fd: c_int, buf: *mut c_void, count: size_t, offset: off_t) -> ssize_t {
    open_coroutine_core::syscall::facade::pread(Some(Lazy::force(&PREAD)), fd, buf, count, offset)
}
...
pub extern "C" fn readv(fd: c_int, iov: *const iovec, iovcnt: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::readv(Some(Lazy::force(&READV)), fd, iov, iovcnt)
}
...
pub extern "C" fn preadv(fd: c_int, iov: *const iovec, iovcnt: c_int, offset: off_t) -> ssize_t {
    open_coroutine_core::syscall::facade::preadv(
        Some(Lazy::force(&PREADV)),
        fd,
        iov,
        iovcnt,
        offset,
...
pub extern "C" fn recvmsg(fd: c_int, msg: *mut msghdr, flags: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::recvmsg(Some(Lazy::force(&RECVMSG)), fd, msg, flags)
}
