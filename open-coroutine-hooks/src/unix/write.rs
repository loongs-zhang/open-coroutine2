...
pub extern "C" fn send(socket: c_int, buf: *const c_void, len: size_t, flags: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::send(Some(Lazy::force(&SEND)), socket, buf, len, flags)
}
...
pub extern "C" fn sendto(
    ...
    open_coroutine_core::syscall::facade::sendto(
...
pub extern "C" fn pwrite(fd: c_int, buf: *const c_void, count: size_t, offset: off_t) -> ssize_t {
    open_coroutine_core::syscall::facade::pwrite(Some(Lazy::force(&PWRITE)), fd, buf, count, offset)
}
...
pub extern "C" fn writev(fd: c_int, iov: *const iovec, iovcnt: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::writev(Some(Lazy::force(&WRITEV)), fd, iov, iovcnt)
}
...
pub extern "C" fn pwritev(fd: c_int, iov: *const iovec, iovcnt: c_int, offset: off_t) -> ssize_t {
    open_coroutine_core::syscall::facade::pwritev(
        Some(Lazy::force(&PWRITEV)),
        fd,
        iov,
        iovcnt,
        offset,
...
pub extern "C" fn sendmsg(fd: c_int, msg: *const msghdr, flags: c_int) -> ssize_t {
    open_coroutine_core::syscall::facade::sendmsg(Some(Lazy::force(&SENDMSG)), fd, msg, flags)
}
